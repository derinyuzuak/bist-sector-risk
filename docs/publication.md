...
Bu proje GitHub’da yayımlanmıştır. Canlı bir web servisi oluşturulmamıştır.
...
7. Sonraki sürümlerde uzak değişiklikleri `main` dalına göndermeden önce proje sahibinin son onayını alın.
